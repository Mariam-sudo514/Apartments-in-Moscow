...
The next stages will migrate the remaining visual system and content using CSS Modules and shared components. The booking API, server-side validation, CAPTCHA strategy, SMTP/email delivery, Docker, Mailpit, and redirects will be added later with separate validation and security review. The Home booking form remains outside the current scope.
